...
#define alpha t0 / 500           //高阶段持续时间均值的倒数，相当于1/(0.5 s)，归一化即128e-9 /slot
#define beta t0 / 30000          //低阶段持续时间均值的倒数，相当于1/(30 s)，归一化即2.13e-9 /slot
#define lambda_on 0.9        //高阶段到达率 = 90 Gb/s，归一化即 0.9 pkt/slot
#define lambda_off 1.0 / 600 //低阶段到达率 = 1.0/6 Gb/s，归一化即 1.67E-3 pkt/slot
